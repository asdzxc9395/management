		...
		<section class="col-12 col-sm-6 col-md-3">
			<form class="form-container" action='add' method='post' method='post' enctype='multipart/form-data'>
  				<div class="form-group">
 				   ...
 				   <input type="email" class="form-control" id=emailInput name='id' aria-describedby="emailHelp">
 				 </div>
 				 <div class="form-group">
 				 ...
 				 <div class="form-group">
 				   ...
 				   <input type="password" class="form-control" name="password" id="passwordInput2">
				  </div>
 				 <div class="form-group">
				  ...
				  <small id="form-label" class="form-text text-muted">비밀번호는 8자 이상이어야 하며, 숫자/소문자/특수문자를 모두 포함해야 합니다.</small>
  				<button type="submit" class="btn btn-primary btn-block" id="completeBtn">등록</button>
   				<button type="button" class="btn btn-primary btn-block" onclick="location.href='../auth/form' ">돌아가기</button>
 				</form>
		</section>
	</section>
</section>
